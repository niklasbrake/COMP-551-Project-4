...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fid = fopen(fullfile('MNIST','train-images.idx3-ubyte'));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fid = fopen(fullfile('MNIST','train-labels.idx1-ubyte'));
...
% xxxx     unsigned byte   ??               pixel
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fid = fopen(fullfile('MNIST','t10k-images.idx3-ubyte'));
info = fread(fid,4,'int32','b');
...
% xxxx     unsigned byte   ??               label
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fid = fopen(fullfile('MNIST','t10k-labels.idx1-ubyte'));
info = fread(fid,2,'int32','b');
